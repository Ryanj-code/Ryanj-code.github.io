  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        <h1 className="text-white text-4xl md:text-6xl font-bold animate-pop-in-1">
          Hi, I'm Ryan Jiang.
        </h1>
        <h2 className="mt-6 text-white text-xl md:text-3xl font-bold animate-pop-in-2">
          A developer passionate about learning.
        </h2>
        <p className="mt-10 text-lg text-gray-300 max-w-4xl mx-auto animate-pop-in-3">
